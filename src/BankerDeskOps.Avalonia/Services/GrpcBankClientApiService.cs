...
/// <summary>
/// gRPC client wrapper for the Bank Client service endpoints.
/// </summary>
public sealed class GrpcBankClientApiService
{
    ...
    private static BankClientDto MapProtoToDto(Api.Protos.BankClient proto) => new()
    {
